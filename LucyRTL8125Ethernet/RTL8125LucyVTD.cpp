...
void LucyRTL8125::interruptOccurredVTD(OSObject *client, IOInterruptEventSource *src, int count)
{
 ...
 * DMA access.
 */
UInt32 LucyRTL8125::txMapPacket(mbuf_t packet,
 ...
 * for reuse.
 */
void LucyRTL8125::txUnmapPacket()
{
 ...
 */
UInt16 LucyRTL8125::rxMapBuffers(UInt16 index, UInt16 count)
{
    IOPhysicalAddress pa;
    IOMemoryDescriptor *md;
    UInt64 length;
...
UInt32 LucyRTL8125::rxInterruptVTD(IONetworkInterface *interface, uint32_t maxCount, IOMbufQueue *pollQueue, void *context)
{
