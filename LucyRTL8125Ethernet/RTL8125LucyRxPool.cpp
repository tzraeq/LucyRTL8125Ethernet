...
OSDefineMetaClassAndStructors(RTL8125LucyRxPool, OSObject);

#define super OSObject

bool RTL8125LucyRxPool::init()
{
    return true;
}

void RTL8125LucyRxPool::free()
{
    if (refillCE) {
...
bool RTL8125LucyRxPool::initWithCapacity(UInt32 mbufCapacity,
...
RTL8125LucyRxPool *
RTL8125LucyRxPool::withCapacity(UInt32 mbufCapacity,
                                UInt32 clustCapacity)
{
    RTL8125LucyRxPool *pool = new RTL8125LucyRxPool;
...
mbuf_t RTL8125LucyRxPool::getPacket(UInt32 size, mbuf_how_t how)
{
    mbuf_t m = NULL;
    void * data;
    errno_t err;
...
void RTL8125LucyRxPool::refillPool()
{
    mbuf_t m;
    void * data;
    errno_t err;
...
void RTL8125LucyRxPool::refillThread(thread_call_param_t param0)
{
    ((RTL8125LucyRxPool *) param0)->refillPool();
}
 ...
 */
mbuf_t RTL8125LucyRxPool::replaceOrCopyPacket(mbuf_t *mp,
                                              UInt32 len,
                                              bool * replaced)
{
    mbuf_t m = NULL;
